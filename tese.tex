...
\author[masc]{Davy Alves de Souza}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% Para TCCs, este comando define o supervisor
% \orientador[fem]{\profa{} \dra{} Renata Wassermann}
\orientador[fem]{Prof. Dr. Renata Wassermann}
% \orientador[fem]{Prof. Renata Wassermann, PhD}
...
\banca{
  % \profa{} \dra{} Renata Wassermann (orientadora) -- IME-USP [sem ponto final],
  % Em inglês, não há o "ª"
  Prof. Dr. Renata Wassermann (advisor) -- IME-USP [sem ponto final],
...
% conteudo (template)
% \input{conteudo/exemplo/00-exemplo-introducao}

\pagestyle{mainmatter}
\input{conteudo/01-belief-revision.tex}
\input{conteudo/02-ontology-engineering.tex}
\input{conteudo/xx-optimal-repairs-as-pseudo-contractions.tex}
\input{conteudo/xx-saturator.tex}
\input{conteudo/xx-resultados.tex}

% conteudo (template)
% \input{conteudo/exemplo/01-exemplo-normas-ime}
% \input{conteudo/exemplo/02-exemplo-usando-o-modelo}
% \input{conteudo/exemplo/03-exemplo-latex}
% \input{conteudo/exemplo/04-exemplo-tutorial}
% \input{conteudo/exemplo/05-exemplo-exemplos}
...
% \input{conteudo/exemplo/apendice-exemplo-faq}
% \par
...
% \input{conteudo/exemplo/anexo-exemplo-imegoodies}
% \par
% \input{conteudo/exemplo/anexo-exemplo-pseudocodigo}
% \par
